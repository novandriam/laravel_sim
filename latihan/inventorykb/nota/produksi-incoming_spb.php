...
header('Content-Disposition: attachment;filename="nota_spb_produksi-incoming"'.date("dmyHis").'".doc"');
...
$sjSql = mysql_query("SELECT * FROM produksi_incoming WHERE nomor='$kodeTransaksi'");
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
  $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, produksi_incoming_detail.nomor,produksi_incoming_detail.id,produksi_incoming_detail.kode,produksi_incoming_detail.jumlah
		FROM produksi_incoming_detail inner join barang on produksi_incoming_detail.kode=barang.kd_barang
		WHERE produksi_incoming_detail.nomor='$kodeTransaksi'
		ORDER BY produksi_incoming_detail.id ");
