...
header('Content-Disposition: attachment;filename="laporan_scrap"'.date("dmyHis").'".doc"');
...
$sjSql = mysql_query("SELECT * FROM scrap WHERE nomor='$kodeTransaksi'");
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  style='font-size:14.0pt'>LAPORAN HASIL SCRAP<o:p></o:p></span></b></p>
...
class=SpellE>diserahkan sejumlah</span> <span class=SpellE>barang</span> <span
class=SpellE>berupa scrap berikut</span> <span class=SpellE>ini:</span></p>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
  $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, scrap_detail.nomor,scrap_detail.id,scrap_detail.kode,scrap_detail.jumlah
		FROM scrap_detail inner join barang on scrap_detail.kode=barang.kd_barang
		WHERE scrap_detail.nomor='$kodeTransaksi'
