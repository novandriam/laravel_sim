...
header('Content-Disposition: attachment;filename="nota_spb_produksi-outgoing"'.date("dmyHis").'".doc"');
...
$sjSql = mysql_query("SELECT * FROM produksi_outgoing WHERE nomor='$kodeTransaksi'");
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
  $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, produksi_outgoing_detail.nomor,produksi_outgoing_detail.id,produksi_outgoing_detail.kode,produksi_outgoing_detail.jumlah
		FROM produksi_outgoing_detail inner join barang on produksi_outgoing_detail.kode=barang.kd_barang
		WHERE produksi_outgoing_detail.nomor='$kodeTransaksi'
		ORDER BY produksi_outgoing_detail.id ");
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'>Gd. Produksi</p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  ...
  oleh</p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><span class=SpellE>Gd. Pengeluaran</span></p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><o:p>&nbsp;</o:p></p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><o:p>&nbsp;</o:p></p>
