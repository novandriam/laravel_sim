...
header('Content-Disposition: attachment;filename="nota_spb_outgoing-produksi"'.date("dmyHis").'".doc"');
...
$sjSql = mysql_query("SELECT * FROM outgoing_produksi WHERE nomor='$kodeTransaksi'");
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
  $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, outgoing_produksi_detail.nomor,outgoing_produksi_detail.id,outgoing_produksi_detail.kode,outgoing_produksi_detail.jumlah
		FROM outgoing_produksi_detail inner join barang on outgoing_produksi_detail.kode=barang.kd_barang
		WHERE outgoing_produksi_detail.nomor='$kodeTransaksi'
		ORDER BY outgoing_produksi_detail.id ");
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  oleh</p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><span class=SpellE>Gd. Produksi</span></p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><o:p>&nbsp;</o:p></p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><o:p>&nbsp;</o:p></p>
