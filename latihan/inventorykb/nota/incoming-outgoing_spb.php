...
header('Content-Disposition: attachment;filename="nota_spb_incoming-outgoing"'.date("dmyHis").'".doc"');
...
$sjSql = mysql_query("SELECT * FROM incoming_outgoing WHERE nomor='$kodeTransaksi'");
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
  $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan,incoming_outgoing_detail.*
		FROM incoming_outgoing_detail inner join barang on incoming_outgoing_detail.kode=barang.kd_barang
		WHERE incoming_outgoing_detail.nomor='$kodeTransaksi'
