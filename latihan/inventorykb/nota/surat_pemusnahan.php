...
header('Content-Disposition: attachment;filename="nota_sj_pemusnahan"'.date("dmyHis").'".doc"');
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  style='font-size:20.0pt'>SURAT JALAN PEMUSNAHAN BARANG<o:p></o:p></span></b></p>
  <p class=MsoNormal align=right style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>Nomor:&nbsp;<?php echo $sjRow['no_pem']; ?> Tanggal: <?php echo IndonesiaTgl($sjRow['tgl_pem']); ?></p>
  </td>
 </tr>
</table>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
 $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, pemusnahan_detail.nomor,pemusnahan_detail.id,pemusnahan_detail.kode,pemusnahan_detail.jumlah
		FROM pemusnahan_detail inner join barang on pemusnahan_detail.kode=barang.kd_barang
		WHERE pemusnahan_detail.nomor='$kodeTransaksi'
