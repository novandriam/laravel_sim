...
header('Content-Disposition: attachment;filename="nota_lpb-incoming"'.date("dmyHis").'".doc"');
...
$lpbSql = mysql_query("SELECT nomor,no_lpb,tgl_lpb,dari,no_spb,tgl_spb from incoming_terima WHERE nomor='$kodeTransaksi'");
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  style='font-size:14.0pt'>LAPORAN PENERIMAAN BARANG (INCOMING)<o:p></o:p>
  </span></b></p>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
 $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, incoming_terima_detail.nomor,incoming_terima_detail.id,incoming_terima_detail.kode,incoming_terima_detail.jumlah
		FROM incoming_terima_detail inner join barang on incoming_terima_detail.kode=barang.kd_barang
		WHERE incoming_terima_detail.nomor='$kodeTransaksi'
