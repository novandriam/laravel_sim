...
header('Content-Disposition: attachment;filename="slip_pemakaian-bahan"'.date("dmyHis").'".doc"');
...
$sjSql = mysql_query("SELECT * FROM produksi WHERE nomor='$kodeTransaksi'");
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  style='font-size:14.0pt'>SLIP PEMAKAIAN BAHAN<o:p></o:p></span></b></p>
  <p class=MsoNormal align=right style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>Nomor:&nbsp;<?php echo $sjRow['no_spb']; ?> Tanggal: <?php echo IndonesiaTgl($sjRow['tgl_spb']); ?></p>
  </td>
 </tr>
</table>
...
normal'>Pimpinan Departemen <?php echo $sjRow['dept']; ?></b></p>

<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'>u.p. <?php echo $sjRow['name_ppc']; ?></p>

<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'><o:p>&nbsp;</o:p></p>

<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'><span class=SpellE>No./Tgl. Request:</span>
<span class=SpellE>&nbsp;<?php echo $sjRow['no_request']; ?>/<?php echo IndonesiaTgl($sjRow['tgl_request']); ?></span>.</p>
<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
  $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, produksi_detail.nomor,produksi_detail.id,produksi_detail.kode,produksi_detail.jumlah
		FROM produksi_detail inner join barang on produksi_detail.kode=barang.kd_barang
		WHERE produksi_detail.nomor='$kodeTransaksi'
		ORDER BY produksi_detail.id ");
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'>Diserahkan oleh</p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'>Gd. Pemasukan</p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  ...
  <td width=213 valign=top style='width:159.6pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><span class=SpellE>Diterima</span>
  oleh</p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><span class=SpellE>Bagian</span>
  Produksi</p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><o:p>&nbsp;</o:p></p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
