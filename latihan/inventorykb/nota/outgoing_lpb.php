...
header('Content-Disposition: attachment;filename="nota_lpb-outgoing"'.date("dmyHis").'".doc"');
...
$lpbSql = mysql_query("SELECT nomor,no_lpb,tgl_lpb,dari,no_spb,tgl_spb from outgoing_terima WHERE nomor='$kodeTransaksi'");
$lpbRow = mysql_fetch_array($lpbSql);
?>
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  style='font-size:14.0pt'>LAPORAN PENERIMAAN BARANG (OUTGOING)
          <o:p></o:p>
  </span></b></p>
  <p class=MsoNormal align=right style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>Nomor:&nbsp;<?php echo $lpbRow['no_lpb']; ?> Tanggal: <?php echo IndonesiaTgl($lpbRow['tgl_lpb']); ?></p>
  </td>
 </tr>
</table>
...
<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'>Pimpinan Gudang <b style='mso-bidi-font-weight:
normal'><?php echo $lpbRow['dari']; ?></b></p>
...
<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'><span class=SpellE>No./Tgl. SPB:</span>
<span class=SpellE><?php echo $lpbRow['no_spb']; ?>/<?php echo IndonesiaTgl($lpbRow['tgl_spb']); ?></span>.</p>
...
class=SpellE>ini</span> kami <span class=SpellE>sampaikan telah menerima</span> <span
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
 $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, outgoing_terima_detail.nomor,outgoing_terima_detail.id,outgoing_terima_detail.kode,outgoing_terima_detail.jumlah
		FROM outgoing_terima_detail inner join barang on outgoing_terima_detail.kode=barang.kd_barang
		WHERE outgoing_terima_detail.nomor='$kodeTransaksi'
		ORDER BY outgoing_terima_detail.id ");
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><span class=SpellE>Yang Menyerahkan</span></p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  ...
  <td width=213 valign=top style='width:159.6pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><span class=SpellE>Mengetahui</span></p>
   <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><o:p>&nbsp;</o:p></p>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal;tab-stops:414.75pt'><o:p>&nbsp;</o:p></p>
