...
header('Content-Disposition: attachment;filename="nota_lpb-produksi"'.date("dmyHis").'".doc"');
...
$lpbSql = mysql_query("SELECT nomor,no_lpb,tgl_lpb,dari,no_spb,tgl_spb from produksi_terima WHERE nomor='$kodeTransaksi'");
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  style='font-size:14.0pt'>LAPORAN PENERIMAAN BARANG (PRODUKSI)
          <o:p></o:p>
  </span></b></p>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
 $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, produksi_terima_detail.nomor,produksi_terima_detail.id,produksi_terima_detail.kode,produksi_terima_detail.jumlah
		FROM produksi_terima_detail inner join barang on produksi_terima_detail.kode=barang.kd_barang
		WHERE produksi_terima_detail.nomor='$kodeTransaksi'
