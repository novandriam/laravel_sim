...
header('Content-Disposition: attachment;filename="nota_bpb"'.date("dmyHis").'".doc"');
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  style='font-size:14.0pt'>BUKTI PENERIMAAN BARANG<o:p></o:p></span></b></p>
  <p class=MsoNormal align=right style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>Nomor:&nbsp;<?php echo $sjRow['no_bpb']; ?> Tanggal: <?php echo IndonesiaTgl($sjRow['tgl_bpb']); ?></p>
  </td>
 </tr>
</table>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
 $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, pemasukan_detail.nomor,pemasukan_detail.id,pemasukan_detail.kode,pemasukan_detail.jumlah
		FROM pemasukan_detail inner join barang on pemasukan_detail.kode=barang.kd_barang
		WHERE pemasukan_detail.nomor='$kodeTransaksi'
