...
header('Content-Disposition: attachment;filename="nota_surat-jalan"'.date("dmyHis").'".doc"');
...
$sjSql = mysql_query("SELECT pengeluaran.*, penerima.* FROM pengeluaran, penerima 
			WHERE pengeluaran.penerima=penerima.kode_penerima AND pengeluaran.nomor='$kodeTransaksi'");
...
absolute; z-index:251659264; margin-left:-11px; margin-top:34px; width:668px; height:6px; left: 23px; top: 1px;'><img width=668 height=6 src="SURAT%20JALAN_files/image001.png"
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  style='font-size:20.0pt'>SURAT JALAN<o:p></o:p></span></b></p>
  <p class=MsoNormal align=right style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'>Nomor:&nbsp;<?php echo $sjRow['no_sj']; ?> Tanggal: <?php echo IndonesiaTgl($sjRow['tgl_sj']); ?></p>
  </td>
 </tr>
</table>
...
normal'><?php echo $sjRow['nama']; ?></b></p>

<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'><?php echo $sjRow['alamat']; ?></p>

<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'><?php echo $sjRow['kota']; ?> - <?php echo $sjRow['negara']; ?></p>

<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'><o:p>&nbsp;</o:p></p>

<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'><span class=SpellE>No./Tgl. Dok Pabean:</span>
<span class=SpellE><?php echo $sjRow['jenis_dokpab']; ?>&nbsp;<?php echo $sjRow['no_dokpab']; ?>/<?php echo IndonesiaTgl($sjRow['tgl_dokpab']); ?></span>.</p>
<p class=MsoNormalCxSpMiddle style='margin-bottom:0in;margin-bottom:.0001pt;
mso-add-space:auto;text-align:justify;tab-stops:414.75pt'><span class=SpellE>No./Tgl Invoice:</span>
<span class=SpellE> <?php echo $sjRow['no_invoice']; ?> / <?php echo IndonesiaTgl($sjRow['tgl_invoice']); ?></span>.</p>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
 $no=1;
 $detail = mysql_query("SELECT barang.kd_barang,barang.nm_barang,barang.satuan, pengeluaran_detail.nomor,pengeluaran_detail.id,pengeluaran_detail.kode,pengeluaran_detail.jumlah
		FROM pengeluaran_detail inner join barang on pengeluaran_detail.kode=barang.kd_barang
		WHERE pengeluaran_detail.nomor='$kodeTransaksi'
...
vglayout;position:absolute;z-index:251660288;left:20px;margin-left:-10px;
margin-top:13px;width:668px;height:2px'><img width=641 height=2
