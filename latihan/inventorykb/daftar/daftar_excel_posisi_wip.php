...
?>
<h2>LAPORAN EXCEL POSISI BARANG DALAM PROSES (WIP)</h2>
<form action="view/view_excel_posisi-wip.php" method="post" name="form1" target="_blank" id="form1">
  <table width="924" border="0"  class="table-list">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><div align="left"><strong>PERIODE TANGGAL PENERIMAAN</strong></div></td>
    </tr>
    <tr>
