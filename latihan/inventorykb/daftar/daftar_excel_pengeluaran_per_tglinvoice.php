...
?>
<h2>LAPORAN EXCEL PENGELUARAN BARANG PER TANGGAL INVOICE</h2>
<form action="view/view_excel_pengeluaran-pertglinvoice.php" method="post" name="form1" target="_blank" id="form1">
