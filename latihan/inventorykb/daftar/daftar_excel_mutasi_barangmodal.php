...
?>
<h2>LAPORAN EXCEL PERTANGGUNGJAWABAN MUTASI MESIN DAN PERALATAN PERKANTORAN</h2>
<form action="view/view_excel_mutasi_barangmodal.php" method="post" name="form1" target="_blank" id="form1">
