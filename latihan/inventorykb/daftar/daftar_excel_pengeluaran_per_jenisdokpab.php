...
?>
<h2>LAP. EXCEL PENGELUARAN BARANG PER JENIS DOK PABEAN</h2>
<form action="view/view_excel_pengeluaran-perjenisdokpab.php" method="post" name="form1" target="_blank" id="form1">
