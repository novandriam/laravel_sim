...
<table class="table-list" width="100%" border="1" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td rowspan="2" width="109" bgcolor="#CCCCCC" align="center"><b>Kode barang </b></td>
    <td rowspan="2" width="121" bgcolor="#CCCCCC" align="left"><b>Nama barang </b></td>
...
<tr>
  ...
  while($rbrg = mysql_fetch_array($brg)){
			...
			$total_pengeluaran = $rpengeluaran[jml]+$routgoingreturn[jml]+$rpemusnahan[jml];
