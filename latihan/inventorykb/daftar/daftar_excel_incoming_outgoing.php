...
?>
<h2>LAP. EXCEL PENGIRIMAN INCOMING - OUTGOING PER TGL. SPB</h2>
<form action="view/view_excel_incoming_outgoing.php" method="post" name="form1" target="_blank" id="form1">
