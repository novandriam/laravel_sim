...
$pageSql = "SELECT T1.kd_barang, T1.nm_barang, T1.satuan, T2.nomor, T2.no_bpb, T2.tgl_bpb, T2.pemasok, T2.no_invoice, T2.tgl_invoice, T3.nomor, T3.kode, T3.jumlah, T3.valuta, T3.nilai, T4.kode_pemasok, T4.nama 
...
<tr>
  ...
  <td width="77" bgcolor="#CCCCCC" align="center" >Tanggal</td>
	...
	$dataSql = "SELECT T1.kd_barang, T1.nm_barang, T1.satuan, T2.nomor, T2.no_bpb, T2.tgl_bpb, T2.pemasok, T2.no_invoice, T2.tgl_invoice, T3.nomor, T3.kode, T3.jumlah, T3.valuta, T3.nilai, T4.kode_pemasok, T4.nama 
	FROM pemasukan As T2 inner join pemasukan_detail As T3 on T2.nomor = T3.nomor inner join pemasok as T4 on T2.pemasok = T4.kode_pemasok inner join barang As T1 on T3.kode = T1.kd_barang
		 WHERE $SqlPeriode
