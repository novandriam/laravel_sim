...
?>
<h2>LAPORAN EXCEL PENGELUARAN BARANG PER DOKUMEN PABEAN</h2>
<form action="view/view_excel_pengeluaran-perdokpab.php" method="post" name="form1" target="_blank" id="form1">
