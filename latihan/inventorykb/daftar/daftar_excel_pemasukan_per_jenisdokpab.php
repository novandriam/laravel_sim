...
?>
<h2>LAP. EXCEL PEMASUKAN BARANG PER JENIS DOK PABEAN</h2>
<form action="view/view_excel_pemasukan-perjenisdokpab.php" method="post" name="form1" target="_blank" id="form1">
