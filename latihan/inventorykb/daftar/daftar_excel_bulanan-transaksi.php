...
?>
<h2>LAPORAN BULANAN TRANSAKSI KEGIATAN PEMASUKAN DAN PENGELUARAN KB</h2>
<form action="view/view_excel_bulanan-transaksi.php" method="post" name="form1" target="_blank" id="form1">
  <table width="924" border="0"  class="table-list">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><div align="left"><strong>PERIODE TANGGAL BPB DAN SURAT JALAN</strong></div></td>
    </tr>
    <tr>
