...
<h2>LAPORAN PERTANGGUNGJAWABAN MUTASI BARANG MODAL DAN PERALATAN PERKANTORAN</h2>
...
<table class="table-list" width="100%" border="1" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td rowspan="2" width="80" bgcolor="#CCCCCC" align="center"><b>Pemasukan </b></td>
    <td rowspan="2" width="80" bgcolor="#CCCCCC" align="center"><b>Pengeluaran </b></td>
    <td rowspan="2" width="80" bgcolor="#CCCCCC" align="center"><b>Penyesuaian </b></td>
...
<tr>
  ...
  while($rbrg = mysql_fetch_array($brg)){
              ...
              echo "<tr><td>$no</td>
                   ...
                   <td>".number_format($rpemasukan[jml],0,'.','.')."</td>
                   <td>".number_format($rpengeluaran[jml],0,'.','.')."</td>
              ...
              $sheet->write($posisi,5,$rpemasukan[jml]);
              $sheet->write($posisi,6,$rpengeluaran[jml]);
