...
?>
<h2>LAPORAN EXCEL PRODUKSI BARANG JADI/SCRAP</h2>
<form action="view/view_excel_barangjadi.php" method="post" name="form1" target="_blank" id="form1">
  <table width="924" border="0"  class="table-list">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><div align="left"><strong>PERIODE TANGGAL PRODUKSI</strong></div></td>
    </tr>
    <tr>
