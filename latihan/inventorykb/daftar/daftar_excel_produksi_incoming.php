...
?>
<h2>LAP. EXCEL PENGIRIMAN PRODUKSI - INCOMING PER TGL. SPB</h2>
<form action="view/view_excel_produksi_incoming.php" method="post" name="form1" target="_blank" id="form1">
