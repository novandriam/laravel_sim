...
?>
<h2>LAPORAN EXCEL PEMASUKAN BARANG PER TANGGAL INVOICE</h2>
<form action="view/view_excel_pemasukan-pertglinvoice.php" method="post" name="form1" target="_blank" id="form1">
