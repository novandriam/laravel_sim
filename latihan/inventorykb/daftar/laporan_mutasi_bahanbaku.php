...
<tr>
  ...
  echo "<form method='post' target='_new' action='view/excel_mutasi_bahanbaku.php'>";
  while($rbrg = mysql_fetch_array($brg)){
			...
			$total_pengeluaran = $rpengeluaran[jml]+$rpemakaian[jml];
              ...
              echo "<tr><td>$no</td>
                   ...
                   <td>$rbrg[satuan]</td>
                   <td align='center'>".number_format($rsaldo_awal[stock],2,',','.')."</td>
                    <td align='center'>".number_format($total_pemasukan,2,',','.')."</td>
                   <td align='center'>".number_format($total_pengeluaran,2,',','.')."</td>
                   <td align='center'>".number_format($radjustment[jml],2,',','.')."</td>
                   <td align='center'>".number_format($saldo_akhir,2,',','.')."</td>
                   <td align='center'>".number_format($rstock_opname[stockopname],2,',','.')."</td>
                   <td align='center'>".number_format($selisih,2,',','.')."</td>
                   <td>$keterangan</td></tr>";
