...
?>
<h2>LAP. EXCEL PEMASUKAN BARANG PER PEMASOK</h2>
<form action="view/view_excel_pemasukan-perpemasok.php" method="post" name="form1" target="_blank" id="form1">
  <table width="924" border="0"  class="table-list">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><div align="left"><strong>JENIS DAN PERIODE TANGGAL BPB</strong></div></td>
    </tr>
        <tr>
      <td><b>Pemasok</b></td>
	  <td><b>:</b></td>
