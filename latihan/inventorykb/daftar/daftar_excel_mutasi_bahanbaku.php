...
?>
<h2>LAPORAN EXCEL PERTANGGUNGJAWABAN MUTASI BAHAN BAKU DAN BAHAN PENOLONG</h2>
<form action="view/view_excel_mutasi_bahanbaku.php" method="post" name="form1" target="_blank" id="form1">
