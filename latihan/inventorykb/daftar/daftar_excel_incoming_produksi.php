...
?>
<h2>LAP. EXCEL PENGIRIMAN INCOMING - PRODUKSI PER TGL. SPB</h2>
<form action="view/view_excel_incoming_produksi.php" method="post" name="form1" target="_blank" id="form1">
