...
?>
<h2>LAP. EXCEL PENGIRIMAN OUTGOING - INCOMING PER TGL. SPB</h2>
<form action="view/view_excel_outgoing_incoming.php" method="post" name="form1" target="_blank" id="form1">
