...
?>
<h2>LAPORAN EXCEL PERTANGGUNGJAWABAN MUTASI BARANG JADI</h2>
<form action="view/view_excel_mutasi_barangjadi.php" method="post" name="form1" target="_blank" id="form1">
