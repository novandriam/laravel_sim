...
if($_GET) {
	...
	$sqlShow = "SELECT * FROM produksi WHERE nomor='$KodeView'";
	...
	$dataNorequest	= $dataShow['no_request'];
	$dataTglrequest	= $dataShow['tgl_request'];
...
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr>
	  <td colspan="3" align="right"><h2>DATA PENYERAHAN BARANG DARI INCOMING KE PRODUKSI</h2></td>
	</tr>
	<tr>
	...
	<tr>
	  <td><b>No request</b></td>
	  <td><b>:</b></td>
	  <td><?php echo $dataNorequest; ?></td></tr>
    <tr>
      <td><b>Tgl request</b></td>
	  <td><b>:</b></td>
	  <td><?php echo IndonesiaTgl($dataTglrequest); ?></td>
    </tr>
    <tr>
...
&nbsp;&nbsp;&nbsp; <a href="nota/spb.php?nomor=<?php echo $KodeView; ?>" target="_new" alt="Cetak SPB" onclick="return confirm('ANDA YAKIN AKAN MENCETAK SPB INI ?')"><img src="images/cetak.jpg" width="20" height="20"  border="0"  alt="Cetak SPB" />Cetak SPB</a></td>
    </tr>
</table>
...
<?php
$tmpSql ="SELECT barang.kd_barang,barang.nm_barang,barang.satuan, produksi_detail.*
		FROM produksi_detail inner join barang on produksi_detail.kode=barang.kd_barang
		WHERE produksi_detail.nomor='$KodeView'
