...
<script type="text/javascript" src="data/outgoing-produksi.js"></script>
...
<div id="divSearch">
  ...
  <table width="100%">
  <tr>
    <td colspan="7" align="right"><h3><b>DATA PENYERAHAN BARANG DARI OUTGOING KE PRODUKSI</b></h3></td>
  </tr>
 <tr>
    <td colspan="7"><a href="?page=Outgoing-Produksi-Add" target="_self"><img src="images/btn_add_data2.png" height="25" border="0" /></a></td>
  </tr>
  <tr>
