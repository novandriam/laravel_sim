...
if($_GET) {
	...
	$sqlShow = "SELECT * FROM outgoing_terima WHERE nomor='$KodeView'";
...
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr>
	  <td colspan="3" align="right"><h2>DATA LPB GUDANG OUTGOING</h2></td>
	</tr>
	<tr>
...
<tr>
	...
	<tr><td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td>
&nbsp;&nbsp;&nbsp;<input type="button" value="Kembali" onclick="self.history.back()" />&nbsp;&nbsp;&nbsp; <a href="nota/outgoing_lpb.php?nomor=<?php echo $KodeView; ?>" target="_new" alt="Cetak LPB" onclick="return confirm('ANDA YAKIN AKAN MENCETAK LPB INI ?')"><img src="images/cetak.jpg" width="20" height="20"  border="0"  alt="Cetak LPB" />Cetak LPB</a></td>
    </tr>
</table>
...
<?php
$tmpSql ="SELECT barang.kd_barang,barang.nm_barang,barang.satuan, outgoing_terima_detail.*
		FROM outgoing_terima_detail inner join barang on outgoing_terima_detail.kode=barang.kd_barang
		WHERE outgoing_terima_detail.nomor='$KodeView'
