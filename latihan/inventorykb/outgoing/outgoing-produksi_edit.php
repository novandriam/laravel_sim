...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){	
			$qryUpdate=mysql_query("UPDATE tmp_outgoing_produksi SET kode='$txtKode', jumlah='$txtJumlah', ket='$txtKet' WHERE id='".$_POST['txtID']."'") 
	...
	$sqlShow = "SELECT barang.kd_barang, barang.nm_barang, barang.satuan, tmp_outgoing_produksi.* 
	FROM tmp_outgoing_produksi inner join barang on tmp_outgoing_produksi.kode=barang.kd_barang
	WHERE tmp_outgoing_produksi.id='$IDEdit'";
...
?>
<form action="?page=Edit-Outgoing-Produksi" method="post" name="frmedit">
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr><input name="txtID" type="hidden" value="<?php echo $dataID; ?>" />
	  <td colspan="3"><h2>UBAH  DETAIL DATA PENYERAHAN BARANG DARI OUTGOING KE PRODUKSI</h2></td>
	</tr>
