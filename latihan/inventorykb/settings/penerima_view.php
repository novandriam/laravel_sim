...
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr>
	  <td colspan="3"><h2>LIHAT DATA PENERIMA</h2> </th>
	</tr>
	<tr>
...
<tr>
	...
	<tr><td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td><a href="?page=Edit-Penerima&amp;Kode=<?php echo $dataKode; ?>" target="_self" alt="Edit Data"><img src="images/btn_edit.png" width="20" height="20" border="0"  />Edit</a>&nbsp;&nbsp;
        <a href="?page=Delete-Penerima&amp;Kode=<?php echo $dataKode; ?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA PENTING INI ... ?')"><img src="images/btn_delete.png" width="20" height="20"  border="0"  alt="Delete Data" />Delete</a>&nbsp;&nbsp;&nbsp;<input type="button" value="Kembali" onclick="self.history.back()" /></td>
