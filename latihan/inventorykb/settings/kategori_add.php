...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){			
			...
			if($qrySave){
					$useractSave=mysql_query("INSERT INTO user_act SET userid='".$_SESSION['SES_LOGIN']."', aktivitas='Menambah data kategori barang dengan nama $txtKategori', tanggal='".date("Y-m-d")."', jam='".date("G:i:s")."'") 
					 or die ("Gagal query".mysql_error());
...
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr>
	  <td colspan="3"><h2>TAMBAH DATA KATEGORI</h2> </td>
	</tr>
	<tr>
