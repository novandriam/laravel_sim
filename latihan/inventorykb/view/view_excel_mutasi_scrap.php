...
header('Content-Disposition: attachment;filename="laporan_mutasi-scrap"'.date("dmy").'".xls"');
...
echo "
<tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PERTANGGUNGJAWABAN MUTASI BARANG SISA DAN SCRAP</div></td>
  </tr>
  <tr>
			...
			$total_pengeluaran = $rpengeluaran[jml]+$routgoingreturn[jml];
              ...
              echo "<tr><td align='center'>$no</td>
                   ...
                   <td align='right'>".number_format($rsaldo_awal[stock],2,',','.')."</td>
                    <td align='right'>".number_format($total_pemasukan,2,',','.')."</td>
                   ...
                   <td align='right'>".number_format($rstock_opname[stockopname],2,',','.')."</td>
