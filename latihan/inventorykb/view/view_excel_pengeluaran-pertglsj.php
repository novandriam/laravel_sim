...
header('Content-Disposition: attachment;filename="laporan_pengeluaran-tglsj"'.date("dmy").'".xls"');
...
echo "<tr>
  ...
  <tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PENGELUARAN BARANG PER TANGGAL SURAT JALAN</div></td>
  </tr>
  <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  <td rowspan=\"2\" ><div align=\"right\">Jumlah</div></td>
  ...
  ";
	...
	WHERE T2.tgl_sj BETWEEN '".InggrisTgl($_POST['cmbTglStart'])."' AND '".InggrisTgl($_POST['cmbTglEnd'])."' 
