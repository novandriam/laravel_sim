...
header('Content-Disposition: attachment;filename="lpb_incoming-pertgllpb"'.date("dmy").'".xls"');
...
echo "<tr>
  ...
  <tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PENERIMAAN BARANG (INCOMING) PER TANGGAL LPB</div></td>
  </tr>
  <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  ";
	...
	FROM incoming_terima_detail As T3 inner join incoming_terima As T2 on T3.nomor=T2.nomor inner join barang As T1 on T3.kode=T1.kd_barang
