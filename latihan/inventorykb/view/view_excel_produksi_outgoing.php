...
header('Content-Disposition: attachment;filename="laporan_pengiriman_produksi-outgoing"'.date("dmy").'".xls"');
...
echo "<tr>
  ...
  <tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PENGIRIMAN PRODUKSI - OUTGOING</div></td>
  </tr>
  <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  ";
	...
	FROM produksi_outgoing As T2 inner join produksi_outgoing_detail As T3 on T2.nomor = T3.nomor inner join barang as T1 on T3.kode = T1.kd_barang
