...
header('Content-Disposition: attachment;filename="laporan_pengiriman_outgoing-incoming"'.date("dmy").'".xls"');
...
echo "<tr>
  ...
  <tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PENGIRIMAN OUTGOING - INCOMING</div></td>
  </tr>
  <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  ";
	...
	FROM outgoing_incoming_detail As T3 inner join outgoing_incoming As T2 on T3.nomor=T2.nomor inner join barang As T1 on T3.kode=T1.kd_barang 
