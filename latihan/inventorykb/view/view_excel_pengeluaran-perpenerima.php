...
header('Content-Disposition: attachment;filename="laporan_pengeluaran-penerima"'.date("dmy").'".xls"');
...
echo "<tr>
  ...
  <tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PENGELUARAN BARANG PER PENERIMA</div></td>
  </tr>
  <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  ";
	...
	WHERE T2.penerima = '$Penerima' 
	AND T2.tgl_sj BETWEEN '".InggrisTgl($_POST['cmbTglStart'])."' AND '".InggrisTgl($_POST['cmbTglEnd'])."' 
