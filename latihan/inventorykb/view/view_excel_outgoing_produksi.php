...
header('Content-Disposition: attachment;filename="laporan_pengiriman_outgoing-produksi"'.date("dmy").'".xls"');
...
echo "<tr>
  ...
  <tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PENGIRIMAN OUTGOING - PRODUKSI</div></td>
  </tr>
  <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  <td rowspan=\"2\" ><div align=\"center\">PPC</div></td>
  ...
  ";
	...
	FROM outgoing_produksi_detail As T3 inner join outgoing_produksi As T2 on T3.nomor=T2.nomor inner join barang As T1 on T3.kode=T1.kd_barang
