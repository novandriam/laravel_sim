...
header('Content-Disposition: attachment;filename="laporan_pengiriman-incoming-produksi"'.date("dmy").'".xls"');
...
echo "<tr>
  ...
  <tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PENGIRIMAN INCOMING - PRODUKSI</div></td>
  </tr>
  <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  ";
	...
	FROM produksi_detail As T3 inner join produksi as T2 on T3.nomor=T2.nomor inner join barang as T1 on T3.kode=T1.kd_barang
