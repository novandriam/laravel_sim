...
header('Content-Disposition: attachment;filename="laporan_pengeluaran-perdokpab"'.date("dmy").'".xls"');
...
echo "<tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PENGELUARAN BARANG PER DOKUMEN PABEAN</div></td>
  </tr>
   <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  <td colspan=\"2\" ><div align=\"center\">Bukti/Dok Pengeluaran</div></td>
  ...
  ";
	...
	WHERE T2.tgl_dokpab BETWEEN '".InggrisTgl($_POST['cmbTglStart'])."' AND '".InggrisTgl($_POST['cmbTglEnd'])."' 
