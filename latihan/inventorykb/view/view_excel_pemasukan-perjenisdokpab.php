...
header('Content-Disposition: attachment;filename="laporan_pemasukan-perjenisdokpab"'.date("dmy").'".xls"');
...
echo "<tr>
  ...
  <tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PEMASUKAN BARANG PER JENIS DOKUMEN PABEAN</div></td>
  </tr>
  <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  ";
	...
	WHERE T2.jenis_dokpab = '$Jenisdokpab' AND T2.tgl_dokpab BETWEEN '".InggrisTgl($_POST['cmbTglStart'])."' AND '".InggrisTgl($_POST['cmbTglEnd'])."' 
