...
header('Content-Disposition: attachment;filename="laporan_produksi-outgoing"'.date("dmy").'".xls"');
...
echo "<tr>
  ...
  <tr>
  <td bgcolor=\"#99CCFF\"><div align=\"left\">LAPORAN PENGIRIMAN BARANG JADI DARI PRODUKSI KE OUTGOING</div></td>
  </tr>
  <tr>
...
echo "<table width=\"458\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\">
  ...
  <td colspan=\"2\" ><div align=\"center\">BPB</div></td>
  ...
  ";
	...
	$query="SELECT T1.kd_barang,T1.nm_barang,T1.satuan, T2.nomor,T2.no_bpb,T2.tgl_bpb,T2.name_ppc, T3.nomor, T3.kode,T3.jumlah 
