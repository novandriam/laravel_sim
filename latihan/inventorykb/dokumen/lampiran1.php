...
$sql = mysql_query("select * from lampiran1 where nomor_pengajuan='$_GET[id]'");
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:3;height:53.9pt'>
  ...
  line-height:196%;font-family:"Arial Narrow","sans-serif";mso-bidi-font-family:
  "Arial Narrow"'><span
  class=SpellE512><span style='letter-spacing:.05pt'><?php echo $r[nomor_pengajuan]?><Br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tanggal</span><span
 ...
 <tr style='mso-yfti-irow:6;height:61.55pt'>
  ...
  style='mso-spacerun:yes'>  </span><?php echo $r[npwp_pengusaha];?></span>
      <o:p></o:p></span></p>
  ...
  style='letter-spacing:2.25pt'> </span><?php echo $r[nama_pengusaha]; ?>
      <o:p></o:p></span></p>
  <p class=MsoNormal style='margin-top:0in;margin-right:0in;margin-bottom:0in;
  ...
  &quot;Arial Narrow&quot;"><?php echo $r[alamat_pengusaha]; ?></span><span style='font-size:8.0pt;font-family:"Arial Narrow","sans-serif";
  ...
  </span><?php echo $r[no_ijin_tpb_pengusaha]; ?></span><span
  ...
  mso-bidi-font-family:"Arial Narrow"'> <?php echo $r[npwp_pengirim]; ?>
    <o:p></o:p>
    </span></p>
  <p class=MsoNormal style='margin-top:0in;margin-right:0in;margin-bottom:0in;
  ...
  </span><?php echo $r[nama_pengirim]; ?></span>
      <o:p></o:p></span></p>
  <p class=MsoNormal style='margin-top:0in;margin-right:0in;margin-bottom:0in;
  margin-left:8.25pt;margin-bottom:.0001pt;line-height:normal;mso-pagination:
  ...
  style='mso-tab-count:1'>    </span>:<span style='mso-spacerun:yes'>   
  </span><?php echo $r[alamat_pengirim]; ?></span></span></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:8;height:46.4pt'>
  <td colspan=6 valign=top style='width:546.1pt;border:solid black 1.0pt;
  border-top:none;mso-border-top-alt:solid black .5pt;mso-border-alt:solid black .5pt;
  padding:0in 0in 0in 0in;height:46.4pt'>
  <p class=MsoNormal style='margin-top:1.8pt;margin-right:0in;margin-bottom:
  0in;margin-left:8.55pt;margin-bottom:.0001pt;line-height:normal;mso-pagination:
  none;tab-stops:70.0pt 293.0pt;mso-layout-grid-align:none;text-autospace:none'><span
  style='font-size:8.0pt;font-family:"Arial Narrow","sans-serif";mso-bidi-font-family:
  ...
  class=GramE>Li<span style='letter-spacing:.05pt'>s</span>t<span
  style='mso-tab-count:1'>  </span>: <span style='letter-spacing:2.2pt'><span
  style='mso-spacerun:yes'> </span></span><?php echo $r[packing_list]; ?> tg</span>l <span
  style='mso-tab-count:1'><?php echo $r[tgl_packing_list]; ?>          </span> <span style='letter-spacing:
  1.7pt'><span style='mso-spacerun:yes'> </span></span><span class=SpellE>                                                             10. Surat</span><span
  style='letter-spacing:-.25pt'> </span><span class=SpellE>Keputusan</span>/<span
  class=SpellE>Persetujuan</span><span style='letter-spacing:-.85pt'> </span>:
      <o:p></o:p>
  </span> <span style="font-size:8.0pt;font-family:&quot;Arial Narrow&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:
  &quot;Arial Narrow&quot;"><?php echo  $r[sk_persetujuan]; ?> tgl <?php echo $r[tgl_persetujuan]; ?>.</span></p>
  <p class=MsoNormal style='margin-top:2.05pt;margin-right:0in;margin-bottom:
  0in;margin-left:8.55pt;margin-bottom:.0001pt;line-height:normal;mso-pagination:
  none;tab-stops:70.0pt 307.0pt;mso-layout-grid-align:none;text-autospace:none'><span
  style='font-size:8.0pt;font-family:"Arial Narrow","sans-serif";mso-bidi-font-family:
  "Arial Narrow"'>9.<span style='mso-spacerun:yes'>    </span><span
  style='letter-spacing:1.8pt'><span style='mso-spacerun:yes'> </span></span><span
  class=SpellE><span class=GramE>Kontrak</span></span><span class=GramE><span
  style='mso-tab-count:1'>         </span>: <span style='letter-spacing:2.2pt'><span
  style='mso-spacerun:yes'> </span></span><?php echo $r[kontrak];?> tgl <?php echo $r[tgl_kontrak]; ?></span><span style='mso-tab-count:1'>          </span>
      <o:p></o:p>
  </span><span style="font-size:
  8.0pt;font-family:&quot;Arial Narrow&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Arial Narrow&quot;"> <span
  style='mso-spacerun:yes'>&nbsp;</span><span class=SpellE1>11. Jenis</span> / <span
  class=SpellE1>nomor</span> / <span
  class=SpellE1>tanggal</span> <span
  class=SpellE1>dokumen</span> <span
  class=SpellE1>lainnya : </span></span><span class="style1"> 
  <?php 
  	$sql = mysql_query("select *,count(jenis_document)as jml from detail_lamp_document where nomor_pengajuan='$r[nomor_pengajuan]' group by
	                    nomor_pengajuan, jenis_document, nomor_document, tgl_document");
	$jml_document = mysql_num_rows($sql);
	$rdocument = mysql_fetch_array($sql); 
    if($jml_document==1){ $document = $rdocument[jenis_document]." \ ".$rdocument[nomor_document]." Tgl. ".$rdocument[tgl_document]; }
  echo $document; ?></span></p>
  <p class=MsoNormal style='margin-top:1.95pt;margin-right:0in;margin-bottom:
  0in;margin-left:293.7pt;margin-bottom:.0001pt;line-height:normal;mso-pagination:
  none;mso-layout-grid-align:none;text-autospace:none'><span style='font-size:
 ...
 <tr style='mso-yfti-irow:10;height:14.6pt'>
  ...
  style='mso-tab-count:1'>             </span>13. <span style='letter-spacing:
 ...
 <tr style='mso-yfti-irow:16;height:15.8pt'>
  ...
  2.25pt'> </span><?php echo $r[berat_kotor]; ?> <span style='mso-tab-count:1'>  </span>20.
  ...
  style='letter-spacing:.05pt'><span style='mso-spacerun:yes'> </span></span><?php echo $r[berat_bersih]; ?></span><span
  style='font-size:12.0pt;font-family:"Times New Roman","serif"'>
  <o:p></o:p></span></p>
  </td>
  <?php
  $sql = mysql_query("select *,count(kode_barang)as jml from detail_lamp_barang where nomor_pengajuan='$r[nomor_pengajuan]'
                      group by nomor_pengajuan, kode_barang, jumlah_barang, harga_penyerahan ");
 ...
 <tr style='mso-yfti-irow:18;height:138.05pt'>
  ...
  normal;mso-pagination:none;mso-layout-grid-align:none;text-autospace:none'><span
  style='font-size:12.0pt;font-family:"Times New Roman","serif"'><o:p>&nbsp;</o:p>
  </span><span class="style1">1.</span></p>
  </td>
  <td colspan=3 valign=top style='width:269.35pt;border-top:none;
  border-left:none;border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;
  mso-border-top-alt:solid black .5pt;mso-border-left-alt:solid black .5pt;
  ...
  <o:p> &nbsp;</o:p>
          ...
          $barang = $rbarang[kode_barang];
		  $jumlah_barang = $rbarang[jumlah_barang];
		  $harga_penyerahan = $rbarang[harga_penyerahan];  
  }?><span
  style='font-size:12.0pt;font-family:"Times New Roman","serif"'>
  <o:p></o:p>
  </span><span style="font-size:8.0pt;font-family:&quot;Arial Narrow&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:
  &quot;Arial Narrow&quot;"><?php echo $barang;?></span></p>
  </td>
  <td width=193 valign=top style='width:134.55pt;border-top:none;border-left:
  none;border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;
  mso-border-top-alt:solid black .5pt;mso-border-left-alt:solid black .5pt;
  ...
  8.0pt;font-family:&quot;Arial Narrow&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Arial Narrow&quot;"><?php echo $jumlah_barang; ?><span
  ...
  style='font-size:8.0pt;font-family:"Arial Narrow","sans-serif";mso-bidi-font-family:
  "Arial Narrow"'><?php echo "Rp. ".number_format($harga_penyerahan,2,',','.');?></span></span><span style='font-size:12.0pt;font-family:"Times New Roman","serif"'>
    <o:p></o:p>
  </span></span></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:20;mso-yfti-lastrow:yes;height:70.55pt'>
  ...
  </span><?php echo $r[nama_pejabat]; ?></span></p>
  <p class=MsoNormal style='margin-top:0in;margin-right:19.95pt;margin-bottom:
  0in;margin-left:127.35pt;margin-bottom:.0001pt;line-height:131%;mso-pagination:
  none;tab-stops:149.0pt;mso-layout-grid-align:none;text-autospace:none'><span
  style='font-size:8.0pt;line-height:131%;font-family:"Arial Narrow","sans-serif";
  ...
  style='mso-tab-count:1'>     </span>:<span style='mso-spacerun:yes'>  </span><span
  style='letter-spacing:.05pt'><span style='mso-spacerun:yes'> </span></span><?php echo $r[nip_pejabat]; ?></span></span><span
  ...
  style='letter-spacing:.05pt'>l</span></span><span class=GramE>   <?php $tgl = date('d M Y'); echo $tgl;?></span>
      <o:p></o:p></span></p>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:5;height:402.85pt'>
  ...
  &quot;Arial Narrow&quot;"> <?php 
  $barang = mysql_query("select * from detail_lamp_barang where nomor_pengajuan='$r[nomor_pengajuan]'");
  while($rbarang = mysql_fetch_array($barang)){
  		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$rbarang[kode_barang]<br><Br><br><br>";
  }
  ?>
  </span>&nbsp;</o:p>
  </span></p>
  ...
  $barang = mysql_query("select * from detail_lamp_barang where nomor_pengajuan='$r[nomor_pengajuan]'");
  while($rbarang = mysql_fetch_array($barang)){
  		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp$rbarang[jumlah_barang]<br><Br><br>";
  }
  ?>
</span>
          <o:p></o:p>
  ...
  $barang = mysql_query("select * from detail_lamp_barang where nomor_pengajuan='$r[nomor_pengajuan]'");
  while($rbarang = mysql_fetch_array($barang)){
  		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rp. ".number_format($rbarang[harga_penyerahan],2,',','.')."<br><Br><br>";
  }
  ?></span>
          <o:p></o:p>
  </span>&nbsp;</o:p></span></p>
