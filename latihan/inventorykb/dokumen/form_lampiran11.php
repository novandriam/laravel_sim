...
<body>
<form id="form1" name="form1" method="post" action="simpan_lampiran1.php?act=insert" padding-left:10px">
<tr>
	  <td colspan="7" align="right"><h2 class="style8">Tambah dokumen BC 4.0</h2></td>
  </tr>
...
<div id="container">
	<ul>
		...
		<li><a href="#fragment-2"><span>Dokumen Pelengkap Pabean</span></a></li>
		<li><a href="#fragment-3"><span>Data Pengangkutan</span></a></li>
	    <li><a href="#fragment-4"><span>Data Perdagangan</span></a></li>
        <li><a href="#fragment-5"><span>Data Pengemas</span></a></li>
        <li><a href="#fragment-6"><span>Data Barang</span></a></li>
        <li><a href="#fragment-7"><span>Pejabat Bea Cukai</span></a></li>
	</ul>
    <div id="fragment-1">
        <table width="86%">
                
    <tr>
      <td width="14%" class="style2">Nomor Pengajuan</td>
    ...
    <div id="fragment-2">
       <table>
    <tr>
      <td><span class="style2">Invoice/Packing list</span></td>
      <td><span class="style2"></span></td>
      <td><span class="style2">
    ...
    <tr>
      <td width="194"><span class="style2">Jenis Sarana Pengangkut Darat</span></td>
    ...
    <tr>
      <td width="144"><span class="style2">Harga Penyerahan</span></td>
    ...
    <div id="fragment-5">
       <table>
          <tr>
      <td width="141"><span class="style2">Jenis Kemasan</span></td>
	...
	?>
      ...
      </span></td>      <td width="68"><span class="style2"></span></td>
      <td width="84"><span class="style2"></span></td>
      <td width="91"><span class="style2"></span></td>
    </tr>
    <tr>
    ...
    <div id="fragment-6">
       <table>
              <tr>
      <td><span class="style2">Volume (m3)</span></td>
      <td><span class="style2"></span></td>
      <td><span class="style2">
    ...
    <div id="fragment-7">
       <table width="435">
         <tr>
      <td><span class="style2">NIP</span></td>
      <td><span class="style2"></span></td>
      <td><span class="style2">
