...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){	
			$qryUpdate=mysql_query("UPDATE tmp_detail_incoming SET kode='$txtKode', jumlah='$txtJumlah', valuta='$cmbValuta', nilai='$txtNilai', netto_detail='$txtNetto_detail', volume_detail='$txtVolume_detail' WHERE id='".$_POST['txtID']."'") 
	...
	$sqlShow = "SELECT barang.kd_barang, barang.nm_barang, barang.satuan, tmp_detail_incoming.* 
	FROM tmp_detail_incoming inner join barang on tmp_detail_incoming.kode=barang.kd_barang
	WHERE tmp_detail_incoming.id='$IDEdit'";
...
?>
<form action="?page=Edit-Trans-Incoming" method="post" name="frmedit">
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr><input name="txtID" type="hidden" value="<?php echo $dataID; ?>" />
	  <td colspan="3"><h2>UBAH  DETAIL UPLOAD DATA PEMASUKAN BARANG </h2></td>
	</tr>
