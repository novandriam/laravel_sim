...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){	
			$qryUpdate=mysql_query("UPDATE tmp_detail_incoming_outgoing SET kode='$txtKode', jumlah='$txtJumlah', ket='$txtKet' WHERE id='".$_POST['txtID']."'") 
	...
	$sqlShow = "SELECT barang.kd_barang, barang.nm_barang, barang.satuan, tmp_detail_incoming_outgoing.* 
	FROM tmp_detail_incoming_outgoing inner join barang on tmp_detail_incoming_outgoing.kode=barang.kd_barang
	WHERE tmp_detail_incoming_outgoing.id='$IDEdit'";
...
?>
<form action="?page=Edit-Trans-Incoming-Outgoing" method="post" name="frmedit">
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr><input name="txtID" type="hidden" value="<?php echo $dataID; ?>" />
	  <td colspan="3"><h2>UBAH  DETAIL UPLOAD DATA PENYERAHAN BARANG DARI INCOMING KE OUTGOING</h2></td>
	</tr>
