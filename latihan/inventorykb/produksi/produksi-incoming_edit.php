...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){	
			$qryUpdate=mysql_query("UPDATE tmp_produksi_incoming SET kode='$txtKode', jumlah='$txtJumlah', ket='$txtKet' WHERE id='".$_POST['txtID']."'") 
	...
	$sqlShow = "SELECT barang.kd_barang, barang.nm_barang, barang.satuan, tmp_produksi_incoming.* 
	FROM tmp_produksi_incoming inner join barang on tmp_produksi_incoming.kode=barang.kd_barang
	WHERE tmp_produksi_incoming.id='$IDEdit'";
...
?>
<form action="?page=Edit-Produksi-Incoming" method="post" name="frmedit">
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr><input name="txtID" type="hidden" value="<?php echo $dataID; ?>" />
	  <td colspan="3"><h2>UBAH  DETAIL DATA PENYERAHAN BARANG DARI PRODUKSI KE INCOMING</h2></td>
	</tr>
