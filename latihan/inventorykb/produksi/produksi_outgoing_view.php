...
if($_GET) {
	...
	$sqlShow = "SELECT * FROM produksi_outgoing WHERE nomor='$KodeView'";
...
<table class="table-list" width="100%" style="margin-top:0px;">
	<tr>
	  <td colspan="3"><h2>DATA PENYERAHAN BARANG DARI PRODUKSI KE OUTGOING</h2></td>
	</tr>
	<tr>
...
<tr>
	...
	<tr><td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td>
&nbsp;&nbsp;&nbsp;<input type="button" value="Kembali" onclick="self.history.back()" />&nbsp;&nbsp;&nbsp; <a href="nota/produksi-outgoing_spb.php?nomor=<?php echo $KodeView; ?>" target="_new" alt="Cetak SPB" onclick="return confirm('ANDA YAKIN AKAN MENCETAK SPB INI ?')"><img src="images/cetak.jpg" width="20" height="20"  border="0"  alt="Cetak SPB" />Cetak SPB</a></td>
    </tr>
</table>
...
<?php
$tmpSql ="SELECT barang.kd_barang,barang.nm_barang,barang.satuan, produksi_outgoing_detail.*
		FROM produksi_outgoing_detail inner join barang on produksi_outgoing_detail.kode=barang.kd_barang
		WHERE produksi_outgoing_detail.nomor='$KodeView'
